    ...
    const handleImageChange = (e) => {
      ...
      useEffect(() => {
        ...
        const fetchData = async () => {
          try {
            const response = await fetch(`http://localhost:5000/getcaremanual/${id}`);
      ...
      const UpdateCareManual = async () => {
        ...
        // ตรวจสอบค่าที่ไม่ได้กำหนด
        if (!caremanual_name || !detail) {
        ...
        try {
          ...
          // ตรวจสอบว่ามีไฟล์ใหม่ถูกเลือกหรือไม่
          if (image) {
          ...
          const response = await fetch(`http://localhost:5000/updatecaremanual/${id}`, {
            method: 'PUT',
            body: formData,
          });
      ...
      return(
        ...
        <div className="auth-inner">
            ...
            <div className="mb-3">
              ...
              <br />
              <br />
              {/* {image && <img src={image} alt="Caremanual" style={{maxWidth: "100%"}} />} */}
              <input
                type="file"
                className="form-control"
                accept="image/*"
