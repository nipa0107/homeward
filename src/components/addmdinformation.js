            ...
            <div className="home_content">
                ...
                <div className="adminall card mb-3">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            >
                                {/* Display all medical professionals from the data state in the dropdown */}
                                {data.map((personnel) => (
                ...
                <div className="btn-group">
                    <div className="btn-pre">
                        <button onClick={() => navigate("/adduser")} className="btn btn-outline py-2">
                            ก่อนหน้า
                        </button>
                    </div>
                    <div className="btn-next">
                        <button onClick={() => navigate("/addequipment")} className="btn btn-outline py-2">
                            ถัดไป
                        </button>
                    </div>
                </div>
